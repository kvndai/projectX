...
var AddtopicComponent = (function () {
    function AddtopicComponent(_cookieService, _httpService, router, _route) {
    ...
    AddtopicComponent.prototype.create = function (form) {
        ...
        this._httpService.createTopic(this.newtopic, this.curruser)
            .then(function (data) { console.log(data); _this.createtopic.emit(); _this.router.navigate(['/dashboard']); })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__addtopic_addtopic_component__ = __webpack_require__("../../../../../src/app/addtopic/addtopic.component.ts");
...
var routes = [
    ...
    { path: 'addtopic', component: __WEBPACK_IMPORTED_MODULE_5__addtopic_addtopic_component__["a" /* AddtopicComponent */] },
